      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={()=>setMethod('rpay')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer rounded-sm'>
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method==='rpay' ? 'bg-green-400' : ''}`}></p>
